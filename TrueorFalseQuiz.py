  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/KY7437/G01Final/blob/main/TrueorFalseQuiz.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "0Pyf2mLJwPco",
        "outputId": "2e510cba-b834-47d7-bd93-d29bb06d9f67"
      },
      "execution_count": 1,
      "outputs": [
        {
